          ...
          <div className="text-center max-w-lg w-full">
            ...
            <div className="flex gap-8 items-start justify-center">
              <div className="flex flex-col items-center gap-3">
                ...
                {revealMyCard && <CoreCard scale={0.5} name={revealMyCard.name} aura={revealMyCard.aura} skill={revealMyCard.skill} stamina={revealMyCard.stamina} totalScore={revealMyCard.total_score} imageUrl={getCardArtUrl(revealMyCard.image_url)} rarity={revealMyCard.rarity} />}
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                {revealTheirCard && <CoreCard scale={0.5} name={revealTheirCard.name} aura={revealTheirCard.aura} skill={revealTheirCard.skill} stamina={revealTheirCard.stamina} totalScore={revealTheirCard.total_score} imageUrl={getCardArtUrl(revealTheirCard.image_url)} rarity={revealTheirCard.rarity} />}
                {state.lastRound.attribute === 'sprint'
